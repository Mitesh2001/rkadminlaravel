...
<div id="kt_header_mobile" class="header-mobile {{ Metronic::printClasses('header-mobile', false) }}" {{ Metronic::printAttrs('header-mobile') }}>
    <div class="mobile-logo">
        <a href="{{ url('/') }}">
            ...
            <img height="50" alt="{{ \Helper::getSetting('app_name') ?? "RKADMIN" }}" src="{{ asset('media/logos/'.$kt_logo_image) }}"/>
        </a>
    </div>
    <div class="d-flex align-items-center">
        ...
        @if (config('layout.header.menu.self.display'))
            <button class="btn p-0 burger-icon ml-4 d-none" id="kt_header_mobile_toggle"><span></span></button>
        @endif
