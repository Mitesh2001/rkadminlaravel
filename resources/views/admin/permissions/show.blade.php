...
@section('content')
    <div class="row">
        @include('partials.permissionheader')
                    ...
                    <span class="tablet__head-label">
                        ...
                        <span>
                            <create-appointment
                                    ...
                                    permission-external-id="{{$permission->external_id}}"
